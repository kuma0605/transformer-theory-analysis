        ...
        <Card>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              ...
              { k: "注意力", v: "一套打分机制，用来决定当前的词该关注前面哪些词、各关注多少" },
            ].map(({ k, v }) => (
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <Bridge title="待解决的问题：这 4 个词向量目前互不相关">
          <div style={{ marginBottom: 10 }}>
            模型目前只知道每个词各自的含义，还不清楚<b>词与词之间的关系</b>。整个过程可以概括成两步：先给前面每个词打分，再按分数把它们的含义并入自身。下面用招聘做类比，说明为什么需要三种向量；不想细看的话，可以直接跳到第 3 步。
          </div>
          <div style={{ marginBottom: 10 }}>
